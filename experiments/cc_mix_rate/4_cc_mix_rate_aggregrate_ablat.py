...
# invert aggregate mix rate
for conf in configs.values():
    conf["aggregate_mix_rate"] = not conf["aggregate_mix_rate"]
# append inv agg to method names
configs = {(k[0], k[1] + "_Inv_Agg", k[2], k[3]): v for k, v in configs.items()}
