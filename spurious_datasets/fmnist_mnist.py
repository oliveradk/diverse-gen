...
def get_fmnist_mnist_datasets(
    ...
    labels_a = [0, 1]
    labels_b = [0, 1]   
    ds_name = "fmnist-mnist"
    source_train = gen_dominos_dataset(ds_name, "source_train", fmnist_train, mnist_train, mix_rate_0_1=source_mix_rate_0_1, mix_rate_1_0=source_mix_rate_1_0, vertical=vertical, transform=transform, pad_sides=pad_sides, labels_a=labels_a, labels_b=labels_b)
    source_val = gen_dominos_dataset(ds_name, "source_val", fmnist_source_val, mnist_source_val, mix_rate_0_1=source_mix_rate_0_1, mix_rate_1_0=source_mix_rate_1_0, vertical=vertical, transform=transform, pad_sides=pad_sides, labels_a=labels_a, labels_b=labels_b)
    target_train = gen_dominos_dataset(ds_name, "target_train", fmnist_target, mnist_target, mix_rate_0_1=target_mix_rate_0_1, mix_rate_1_0=target_mix_rate_1_0, vertical=vertical, transform=transform, pad_sides=pad_sides, labels_a=labels_a, labels_b=labels_b)
    target_val = gen_dominos_dataset(ds_name, "target_val", fmnist_target_val, mnist_target_val, mix_rate_0_1=target_mix_rate_0_1, mix_rate_1_0=target_mix_rate_1_0, vertical=vertical, transform=transform, pad_sides=pad_sides, labels_a=labels_a, labels_b=labels_b)
    target_test = gen_dominos_dataset(ds_name, "target_test", fmnist_test, mnist_test, mix_rate_0_1=0.25, mix_rate_1_0=0.25, vertical=vertical, transform=transform, pad_sides=pad_sides, labels_a=labels_a, labels_b=labels_b)
