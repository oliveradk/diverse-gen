...
def get_toy_grid_dataset(
    ...
    source_quadrant_proportions = [source_non_mix_rate / 2, source_mix_rate_0_1, source_mix_rate_1_0, source_non_mix_rate / 2]
    target_non_mix_rate = 1 - target_mix_rate_0_1 - target_mix_rate_1_0
    target_quadrant_proportions = [target_non_mix_rate / 2, target_mix_rate_0_1, target_mix_rate_1_0, target_non_mix_rate / 2]
    ...
    source_train = t.utils.data.TensorDataset(t.tensor(source_train[0]), t.tensor(source_train[1]))
    source_val = t.utils.data.TensorDataset(t.tensor(source_val[0]), t.tensor(source_val[1]))
    target_train = t.utils.data.TensorDataset(t.tensor(target_train[0]), t.tensor(target_train[1]))
    target_val = t.utils.data.TensorDataset(t.tensor(target_val[0]), t.tensor(target_val[1]))
    target_test = t.utils.data.TensorDataset(t.tensor(target_test[0]), t.tensor(target_test[1]))
